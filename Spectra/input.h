...
/* File names */
#define OUTPUT_PREFIX "OUT/Spec_0_UPS-LOW-G-EXT-CLOUDY-250_phase_7_inc_0.0"      /* output name */
#define T_P_3D_FILE "DATA/Final_UPS-LOW-G-EXT-CLOUDY-250_phase_7_inc_0.0.txt"         /* input file */
...
#define INPUT_PHASE 7              /* Planet inclination in degrees           */
