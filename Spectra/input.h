...
/* File names */
#define OUTPUT_PREFIX "OUT/Spec_0_UPS-LOW-G-CLEAR-250_phase_0.0_inc_0.0"      /* output name */
#define T_P_3D_FILE "DATA/Final_UPS-LOW-G-CLEAR-250_phase_0.0_inc_0.0.txt"         /* input file */
